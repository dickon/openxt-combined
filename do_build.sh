...
do_oe_setup()
{
	...
	oedl=${TOPDIR}/build/oe/oe-download
        ...
        local REPO_PROD_CACERT_PATH="$(resolve_path "$TOPDIR" "../build-config/repo-cert/prod-cacert.pem")"
        local REPO_DEV_CACERT_PATH="$(resolve_path "$TOPDIR" "../build-config/repo-cert/dev-cacert.pem")"
...
# this file is autogenerated by the setupoe step of do_build.sh; do not edit
# instead override in openxt.git/local.conf after including this file
# Distribution feed
